...
export const metadata: Metadata = {
  ...
  description: "The right tone should never depend on who is typing. A unified customer-facing voice across every operational layer.",
};
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .touch-list { list-style: none; margin-top: 0.5rem; display: flex; flex-direction: column; gap: 0.6rem; }
        .touch-list li { font-size: 1rem; color: #A7AFBD; padding-left: 1.25rem; position: relative; line-height: 1.7; }
        .touch-list li::before { content: '·'; position: absolute; left: 0; color: var(--dim); }
      ...
      <main>
        <section className="tool-hero">
          <div className="tool-hero-inner">
            ...
            <p className="tool-tagline">
              The right tone<br />
              should never depend on who is typing.
            </p>
            <p className="tool-desc">
              Premium brands lose trust when communication becomes inconsistent.
            </p>
          </div>
        </section>
        ...
        <section className="tool-section">
          <div className="content-wrap">
            ...
            <ul className="touch-list">
              ...
              <li>Reservation messages.</li>
              <li>Customer replies.</li>
              <li>Service explanations.</li>
            </ul>
            <p style={{ marginTop: "2rem" }}>
              SMBkits maintains a centralized voice structure aligned with your business identity.
            </p>
          </div>
        </section>
        ...
        <section className="tool-section">
          <div className="content-wrap">
            ...
            <ul className="biz-list">
              <li>culinary-focused restaurants</li>
              <li>wine programs</li>
              <li>specialty coffee brands</li>
              <li>wellness spaces</li>
              <li>private service businesses</li>
            </ul>
          </div>
        </section>
        ...
        <section className="tool-section">
          <div className="content-wrap">
            <h2 className="section-lead">
              The objective is not<br />
              marketing language.<br />
              <em>It is tonal discipline.</em>
            </h2>
        ...
        <section className="outcome-section">
          <div className="outcome-inner">
            ...
            <p>Quietly consistent.</p>
            <p>Professionally restrained.</p>
