...
export const metadata: Metadata = {
  title: "Social Presence — SMBkits",
  description: "Maintain a calm, coherent public presence across every customer-facing channel. Reputational stability for independent premium businesses.",
};
      ...
      <main>
        <section className="tool-hero">
          <div className="tool-hero-inner">
            ...
            <p className="tool-tagline">
              Consistency creates trust<br />
              before customers ever arrive.
            </p>
            <p className="tool-desc">
              Premium businesses are judged long before the first reservation, appointment, or visit.
            </p>
          </div>
        </section>
        ...
        <section className="tool-section">
          <div className="content-wrap">
            ...
            <p>The issue is rarely visibility.</p>
            <p>It is alignment.</p>
        ...
        <section className="tool-section">
          <div className="content-wrap">
            <h2 className="section-lead">
              ...
              growth hacking.<br />
              <em>It is reputational stability.</em>
            </h2>
        ...
        <section className="tool-section">
          <div className="content-wrap">
            ...
            <ul className="biz-list">
              ...
              <li>independent premium operators</li>
            </ul>
          </div>
        </section>
